...
class ControllerExtensionModuleOCNCategoryWallPro extends Controller {
	...
	public function index() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			...
			if (isset($this->request->post['apply']) && $this->request->post['apply']) {
				$this->response->redirect($this->url->link('extension/module/ocn_category_wall_pro', 'user_token=' . $this->session->data['user_token'] . '&module_id=' . $this->request->get['module_id'], true));
			}
	...
	protected function getForm() {
		$default_data = [
			...
			'module_ocn_category_wall_pro_categories_selected' => array(),
			'module_ocn_category_wall_pro_categories_custom' => array()
		];
		...
		if (!isset($this->request->get['module_id'])) {
			...
			$data['url_action'] = $this->url->link('extension/module/ocn_category_wall_pro', 'user_token=' . $this->session->data['user_token'] . '&module_id=' . $this->request->get['module_id'], true);
		}		
